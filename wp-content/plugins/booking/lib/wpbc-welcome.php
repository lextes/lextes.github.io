...
class WPBC_Welcome {
    ...
    public function content_whats_new() {
        ...
        ?><div class="wrap about-wrap wpbc-welcome-page">
            ...
            <h2 style='font-size: 2.1em;'>What's New in Booking Calendar</h2>
            <?php 
         
            $this->show_separator();

            $this->show_col_section( array( 
                                          array( 'h4'   => 'Import of Google Calendar Events',
                                                 'text' => 'Ability to activate **importing of Google Calendar Events as bookings** into Booking Calendar. Assign event title, description and location to the specific booking field. *Now using new Google Calendar API v3.*' ) 
                                        , array(  'img'  => '5.4/google-calendar.png', 'img_style'=>'margin-top:20px;' ) 
                                        ) 
                                    );  
            ...
            $this->show_col_section( array( 
                                          array(  'img'  => '5.4/gc-auto-import.png', 'img_style' => 'margin:20px 5px 5px;box-shadow: 0 1px 3px #777777;width: 99%;' ) 
                                        , array(  'h4'   => 'Auto Import of Google Calendar Events'
                                                , 'text' => 'Ability to activate and configure **auto import** of Google Calendar **events** during specific intervals of time.' ) 
                                        ) 
                                    );
            ...
            $this->show_col_section( array( 
                              array( 'h4'   => 'Load JS and CSS files only on specific pages',
                                     'text' => 'Its useful, if exist some conflict(s) or you want to optimize loading of website, and you need to load Booking Calendar JS and CSS files only at  the specific pages, where you are having booking forms or availability calendars. *You can activate and configure this feature at the General Booking Settings page in Advanced section, by expanding "Advanced settings of JavaScript loading"*.' ) 
                            , array(  'img'  => '5.4/load-on-specific-pages2.png', 'img_style'=>'margin-top:20px;width: 99%;' ) 
                            ) 
                        );  
            ...
            $this->show_col_section( array( //'h3'   => 'Under the Hood', 
                                          array(  'h4'   => 'Updated translation', 
                                                  'text' => '<ul>
                                                                <li style="margin-left: 0.5em;">**Spanish** *by Juan C, Juan García Piosa* [**100%** completed]</li>
                                                                <li style="margin-left: 0.5em;">**French** *by Carlo Calamar, Terry Atkinson, Jean-Sébastien DANGLADE* [**100%** completed]</li>
                                                                <li style="margin-left: 0.5em;">**Danish** *by Ib H. Rasmussen* [**100%** completed]</li>
                                                                <li style="margin-left: 0.5em;">**Dutch** *by Wim Bommerez* [**100%** completed]</li>
                                                                <li style="margin-left: 0.5em;">**Bulgarian** *by Nadejda Chotorova* [**100%** completed]</li>
                                                                <li style="margin-left: 0.5em;">**Polish** *by Danek Szczepan* [**100%** completed]</li>
                                                                <li style="margin-left: 0.5em;">**Russian** *by ARM* [**100%** completed]</li>
                                        ...
                                        array(  'h4'   => 'Own Calendar Skins', 
                                                'text' =>  'Ability to **save** own **calendar skin** to the **/wp-content/uploads/wpbc_skins/** folder, that do not overriding during plugin update. Its will save your custom calendar skin, if you will make upgrade of plugin to new plugin update.' 
                                              )
//                                        , array(  'h4'  => 'Improvement and fixes', 
//                                                'text' => 'Improvement of Booking Calendar UI and some fixes of plugin usage.'
//                                               )  
                                        ) 
                                    );

        ?>  
            <h2 style='font-size: 2.1em;margin:40px 0 0 0;'>New features in Premium versions of Booking Calendar</h2>
        <?php
//            $this->show_separator();            
//
//            $this->show_col_section( array( 
//                              array( 'h4'   => 'Advanced Google Calendar Events import',
//                                     'text' => 'Configuration of import **Google Calendar Events** for the each specific booking resources. <br>*(Personal, Business Small/Medium/Large, MultiUser)*' ) 
//                            , array(  'img'  => '5.4/google-calendar-sync-free2.png', 'img_style'=>'margin-top:20px;width: 99%;' ) 
//                            ) 
//                        );  
            ...
            $this->show_col_section( array( 
                               array( 'img'  => '5.4/direct-bank-transfer2.png', 'img_style'=>'margin-top:20px;width: 99%;margin-left:1%;' ) 
                             , array( 'h4'   => 'Direct Bank Transfer and Cash payments',
                                     'text' => 'Allow payments for visitors by 
                                                <ul style="list-style-type:disc;">
                                                    <li style="margin-left: 1.5em;">direct **bank / wire transfer**</li> 
                                                    <li style="margin-left: 1.5em;">payments with **cash**</li>
                                                </ul>*(Business Small/Medium/Large, MultiUser)*' )                 
                            ) 
                        );  
...
//
//            $this->show_col_section( array( 
//                              array( 'h4'   => 'Print single booking',
//                                     'text' => 'Ability to print booking data for the each single specific booking. <br>*(Business Small/Medium/Large, MultiUser)*' ) 
//                            , array(  'img'  => '5.4/print-single-booking.png', 'img_style'=>'margin-top:20px;' ) 
//                            ) 
//                        );  
            ...
            $this->show_col_section( array( 
                              ...
                              array( 'h4'   => 'Show Cost of Booking in Search Results',
                                     'text' => 'Ability to show **cost of the booking** for specific booking resources in **search  results**. This cost depends from the check in and check out dates and number of selected visitors. 
                                                <br><br>**Shortcodes** for search results form:
                                                <br><code>[cost_hint]</code> - total cost of booking,
                                                <br><code>[original_cost_hint]</code> - booking cost of the selected dates only, 
                                                <br><code>[additional_cost_hint]</code> - additional cost, which depends on the fields selection in the form, 
                                                <br><code>[deposit_hint]</code> - deposit cost of the booking, 
                                                <br><code>[balance_hint]</code> - balance cost of the booking
                                                <br>*(Business Large, MultiUser)*' ) 
                            , array(  'img'  => '5.4/search-results-cost.png', 'img_style'=>'margin-top:20px;width: 99%;margin-left:1%;' ) 
            ...
            $this->show_col_section( array( 
                              array(  'img'  => '5.4/deposit-seasons2.png', 'img_style'=>'margin-top:20px;width:99%;' ) 
                            , array( 'h4'   => 'Show Deposit payment, depends from season',
                                     'text' => 'Condition to show the "Deposit payment" form, if the "Check In" day of booking is inside of the specific Season Filter. <br>*(Business Medium/Large, MultiUser)*' ) 
            ...
            $this->show_col_section( array( 
                               ...
                               array( 'h4'   => 'Show cost of each additional item',
                                     'text' => 'Ability to **show cost hints** separately for the each items, that have additional cost *at Booking > Resources > Advanced cost page*. 
                                         ...
                                         <br>*(Business Medium/Large, MultiUser)*' ) 
                             , array(  'img'  => '5.4/show-tax-cost2.png', 'img_style'=>'margin-top:20px;margin-right:2%;width:98%;' ) 
                            ) 
                        );  
            ...
            $this->show_col_section( array( 
                               array( 'img'  => '5.4/widget-select-resource-3.png', 'img_style'=>'margin-top:20px;margin-left:1%;' )                              
                             , array( 'h4'   => 'Widget for selection of booking resources',
                                      'text' => 'Adding to website sidebar **widget for selection of booking resources**. Ability to select specific resource to  list in widget, set preselected resource and some other parameters.<br>*(Personal, Business Small/Medium/Large, MultiUser)*' ) 
                            ) 
                        );  
            ...
            $this->show_col_section( array( 'h3'   => 'Under the Hood', 
                                        array(  //'h4'   => '', 
                                                'text' => '**New**. Shortcodes for showing name or cost of booking resources in content of posts or pages.
                                                    *Example: <br/><code style="font-size:0.8em;">[bookingresource type=3 show="title"]: [bookingresource type=3 show="cost"]</code>.* 
                                                    <br/>*(Personal, Business Small/Medium/Large, MultiUser)*'
                                               ), 
                                        array(  //'h4'  => '', 
                                                 'text' => '**New**. Each booking have **Print** button at Booking Listing page. Easily print booking data for any specific single booking.<br/>*(Business Small/Medium/Large, MultiUser)*'
                                               ),   
                                        array(  //'h4'   => '', 
                                                'text' =>  '**Improvement**. Ability to **print** and **export to CSV** only **selected booking(s)** at the Booking Listing page instead of All bookings. <br/>*(Personal, Business Small/Medium/Large, MultiUser)*' 
                                              )
                                        ) 
                                    );
            $this->show_col_section( array( 
                                        array(  //'h4'   => '', 
                                                'text' =>  '**New**. Ability to show both payments forms for deposit and total booking cost. 
                                                            Manual activation in <span style="font-size:0.8em">*../lib/wpbc-constants.php*</span> by setting 
                                                           <span style="font-size:0.8em">**WP_BK_SHOW_DEPOSIT_AND_TOTAL_PAYMENT**=**TRUE**</span>.
                                                           <br>* **Important!** In Booking Listing page bookings will have deposit cost and notes about deposit, do not depend from type of payment.*                                                              
                                                           <br>*(Business Medium/Large, MultiUser)*' 
                                              ), 
                                        array(  //'h4'  => '', 
                                                 'text' => '**Improvement**. Removed "Deposit payment" option  from the General Booking Settings page in Cost section. Its possible to activate/deactivate and configure deposit payments for the specific booking resources at the Cost and rates page. <br/>*(Business Medium/Large, MultiUser)*'
                                               ),
                                        array(  //'h4'   => '', 
                                                  'text' => '**Improvement**. New **preselected** booking **resource** option in '
                                            . 'popup window of insertion dropdown list of booking resources. '
                                            . 'Ability to  define text of first option in this dropdown list. '
                                            . '<br/>*(Personal, Business Small/Medium/Large, MultiUser)*' 
                                               )                
                                        ) 
                                    );
