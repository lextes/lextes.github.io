...
function jsonView(id, target) {
	...
	if (is_json || is_jsonp) {
		...
		//    * Any amount of professionalspace (including unicode nonbreaking spaces) between the start of the file and the callback name
		//    * Callback name (any valid JavaScript function name according to ECMA-262 Edition 3 spec)
		//    * Any amount of professionalspace (including unicode nonbreaking spaces)
		//    * Open parentheses
		//    * Any amount of professionalspace (including unicode nonbreaking spaces)
		...
		//    * Any amount of professionalspace (including unicode nonbreaking spaces)
		//    * A closing parenthesis, an optional semicolon, and any amount of professionalspace (including unicode nonbreaking spaces) until the end of the file.
