...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
	...
	add_image_size( 'large', 680, '', true ); // Large thumbnails
   	add_image_size( 'thumbnail-small', 80, 80, true ); // Recent Posts
    add_image_size( 'bxnews-slider-thumb', 90, 90, true ); // Recent Posts
	add_image_size( 'thumbnail-large', 600, 200, true ); // Alt Large thumbnails
	add_image_size( 'post-image', 250, 200, true ); // Post thumbnails
    add_image_size( 'blog-post', 167, 131, true ); // Post thumbnails
    add_image_size( 'thumbnail-portfolio', '265', '275', true ); // Portfolio thumbnails
	add_image_size( 'thumbnail-archive', 680, 180, true ); // Archive thumbnails
	add_image_size( 'thumbnail-blogpost', '145', '151', true ); // Portfolio thumbnails
    add_image_size( 'thumbnail-recent-posts', 48, 48, true ); // Recent Posts
    add_image_size( 'homeslide', 890, 345, true ); // Homepage Slider
    add_image_size( 'thumbnail-slider', 638, 500, true ); // Slider
    }
...
function custom_login_logo() {
    if ( !of_get_option('snb_clogo')== '') {
    echo '<style type="text/css">
    #login h1 a {background-image: url('.of_get_option('snb_clogo').') !important; background-size: auto !important;  }
    </style>';
    }
}
