<?php
    ...
    $options[] = array( "name" => "Footer Actions",
                        "desc" => "Display Footer Twitter & Quick Contact Section",
                        "id" => $shortname."_footer_actions",
                        "std" => "yes",
                        "type" => "select",
                        "options" => array("yes"=>"yes","no"=>"no"));
    
    $options[] = array( "name" => "Default Visibility",
                        "desc" => "",
                        "id" => $shortname."_actions_hide",
                        "std" => "visible",
                        "type" => "select",
