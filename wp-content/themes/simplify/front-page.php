...
<div id="container">
<h1 id="heading"><?php echo esc_textarea(of_get_option('heading-text', 'Welcome to the World of Creativity!')); ?></h1>
<p class="heading-desc"><?php echo esc_textarea(of_get_option('heading-des', 'WordPress is web software you can use to create a beautiful website or blog. We like to say that WordPress is both free and priceless at the same time.')); ?></p>
...
<?php if (esc_html(of_get_option('fpost', '0')) != '1'): if ( 'posts' == get_option( 'show_on_front' ) ): get_template_part( 'blog' ); endif; endif;?> 
